...
# 20 must follow 21: the SI per-flight map titles read the York fossil fraction
# out of table1.csv, so running 20 first labels the panels with the PREVIOUS
# run's fossil fractions.
...
run_step("31 DJB basin ethane:methane (2024 basin ratio)", "scripts/31_basin_ethane_trend.R", required = FALSE)
